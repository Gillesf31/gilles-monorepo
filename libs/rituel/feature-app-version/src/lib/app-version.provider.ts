...
export class AppVersionService {
  ...
  private readonly storageKey = 'rituel-app-version';
  private readonly dismissedStorageKey = 'rituel-app-version-dismissed';
...
export function provideAppVersionCheck(checkForUpdates = true) {
