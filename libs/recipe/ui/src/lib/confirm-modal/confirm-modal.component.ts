  ...
  template: `
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        ...
        aria-label="Fermer"
      ></div>
      <div class="relative z-10 w-full max-w-sm rounded-xl bg-white dark:bg-gray-900 shadow-xl p-6 flex flex-col gap-4">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-50">{{ title() }}</h2>
